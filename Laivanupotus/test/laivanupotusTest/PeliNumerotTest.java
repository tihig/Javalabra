...
public class PeliNumerotTest {
    ...
    public void peliMuuntaminen0() {
        assertEquals(0, game.muutaArvoY("A1"));
    }

    @Test
    public void peliMuuntaminen1() {
        assertEquals(1, game.muutaArvoY("A2"));
    }

    @Test
    public void peliMuuntaminen2() {
        assertEquals(2, game.muutaArvoY("A3"));
    }

    @Test
    public void peliMuuntaminen3() {
        assertEquals(3, game.muutaArvoY("A4"));
    }

    @Test
    public void peliMuuntaminen4() {
        assertEquals(4, game.muutaArvoY("A5"));
    }

    @Test
    public void peliMuuntaminen5() {
        assertEquals(5, game.muutaArvoY("A6"));
    }

    @Test
    public void peliMuuntaminen6() {
        assertEquals(6, game.muutaArvoY("A7"));
    }

    @Test
    public void peliMuuntaminen7() {
        assertEquals(7, game.muutaArvoY("A8"));
    }

    @Test
    public void peliMuuntaminen8() {
        assertEquals(8, game.muutaArvoY("A9"));
    }

    @Test
    public void peliMuuntaminen9() {
        assertEquals(9, game.muutaArvoY("A10"));
    }
